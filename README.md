...
Nuancera 的隐私政策见 [PRIVACY.md](PRIVACY.md)。Microsoft Partner Center 的隐私政策 URL 可使用：
...
Nuancera's privacy policy is available in [PRIVACY.md](PRIVACY.md). For Microsoft Partner Center, use this privacy policy URL:
